...
public class AutorController {
	...
	public ResponseEntity<Page<Object[]>> listarVistaAutores(@PathVariable int page, @PathVariable int size){
		Page<Object[]> autors = service.listarVistaAutores(page, size);
